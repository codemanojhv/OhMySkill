...
public static class SelfCheck
{
    public static bool Run()
    {
        try
        {
            ...
            evidenceTrace.Actions.Add(new ActionEvidence(actionId, 1, 100, 400, TraceEventKind.Click, "left click", null, evidenceFrame, evidenceFrame with { Id = "after-1", Role = FrameRole.After, ElapsedMilliseconds = 400 }, [new TranscriptSegment(0, 500, "Open the report", 0.9)]));
            ...
            Assert(TranscriptSegmenter.Split("Open the report. Verify the result.", 2000, 0.9).Count == 2, "transcript segmentation");
